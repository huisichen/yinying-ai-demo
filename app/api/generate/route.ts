...
function fallbackPlan(input:Input,hits:ReturnType<typeof retrieve>){
  ...
  const lines=age.label==='活力银发'?
    ...
    age.label==='高龄银发'?
    [['场景','场景一 · 家中客厅 · 日 · 内'],['画面','手机连续响起，孙奶奶戴上老花镜。'],['孙奶奶',`有人说，要办“${topic.slice(0,10)}”。`],['陌生来电','点开链接。马上办。'],['陌生来电','不要告诉家人。'],['孙奶奶','为什么不能告诉家人？'],['画面','孙奶奶没有点击，把手机放到桌上。'],['场景','场景二 · 社区服务站 · 日 · 内'],['小陈','奶奶，先挂电话。'],['孙奶奶','不点链接，对吗？'],['小陈','对。验证码也不说。'],['画面','小陈打开免提，从官方页面找号码。'],['官方客服','没有这笔退款。不要继续操作。'],['孙奶奶','先挂断。找人帮忙。再核实。'],['场景','场景三 · 楼道口 · 日 · 外'],['孙奶奶','刚才有人催我点链接，我没有点。'],['邻居','下次碰到这种电话怎么办？'],['孙奶奶','先挂断，不点，也不说验证码。'],['小陈',core],['邻居','看不清就找家人一起核实。'],['孙奶奶',age.closing],['旁白','看不清、听不明、被催促时，先停下来找人帮忙。']]:
